...
WebUI.click(findTestObject('ANTHEA KEJAGUNG AUTOMATION VERSI 01/user/06_penyelenggara/a_User'))

WebUI.click(findTestObject('ANTHEA KEJAGUNG AUTOMATION VERSI 01/user/06_penyelenggara/a_Penyelenggara'))
