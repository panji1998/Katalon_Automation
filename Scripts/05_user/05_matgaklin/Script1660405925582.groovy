...
WebUI.click(findTestObject('ANTHEA KEJAGUNG AUTOMATION VERSI 01/user/05_matgaklin/a_User'))

WebUI.click(findTestObject('ANTHEA KEJAGUNG AUTOMATION VERSI 01/user/05_matgaklin/a_Matgaklin'))
